...
function LocationBlocks({ reduceMotion }: { reduceMotion: boolean | null }) {
  return (
    <motion.div
      id="find-address"
...
function ActionButtons({ reduceMotion }: { reduceMotion: boolean | null }) {
  return (
    <motion.div
      id="find-cta"
...
function FloatingPlate({ reduceMotion, photoY }: { reduceMotion: boolean | null; photoY: MotionValue<number> }) {
    ...
    >
      ...
      <div className="relative z-10 mx-auto grid max-w-7xl items-center gap-16 px-5 sm:px-6 lg:grid-cols-2 lg:gap-12 lg:px-10">
        ...
        <div className="order-1 max-w-xl">
          ...
          <LocationBlocks reduceMotion={reduceMotion} />
          <ActionButtons reduceMotion={reduceMotion} />
        </div>

        <FloatingPlate reduceMotion={reduceMotion} photoY={photoY} />
      </div>
    </section>
  );
}

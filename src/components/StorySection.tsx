...
function StoryCopy({ reduceMotion }: { reduceMotion: boolean | null }) {
  ...
  return (
    <div className="order-1 max-w-xl lg:order-2">
      ...
      >
        Jack&rsquo;s Burger isn&rsquo;t just food — it&rsquo;s a vibe. We&rsquo;re
        kicking off in North Wales, but soon we&rsquo;ll be smashing burgers
        across the UK and beyond. Hop aboard this tasty rocket and let&rsquo;s make
        burger history.
      </motion.p>
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto grid max-w-7xl items-center gap-16 px-5 sm:px-6 lg:grid-cols-2 lg:gap-12 lg:px-10">
        ...
        <StoryVisual visualY={visualY} reduceMotion={reduceMotion} />

        {/* Right — copy */}
        <StoryCopy reduceMotion={reduceMotion} />
      </div>
    </section>
  );
}

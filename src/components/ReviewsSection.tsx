...
function HugeSmashBurger({
  burgerY,
  reduceMotion,
}: {
  burgerY: MotionValue<number>;
...
function RealPromise({ reduceMotion }: { reduceMotion: boolean | null }) {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto grid max-w-7xl items-center gap-16 px-5 sm:px-6 lg:grid-cols-[45fr_55fr] lg:gap-12 lg:px-10">
        ...
        <HugeSmashBurger burgerY={burgerY} reduceMotion={reduceMotion} />

        {/* Right — the real promise */}
        <RealPromise reduceMotion={reduceMotion} />
      </div>
    </section>
  );
}
